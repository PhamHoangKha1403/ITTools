...
function UserManager() {
  ...
  return (
    ...
    <div className="text-white p-6">
      ...
      <div className="bg-neutral-850 rounded-lg shadow-lg border border-neutral-700 overflow-x-auto">
        <table className="w-full min-w-[400px] text-left table-fixed border-collapse">
          ...
          <tbody className="text-gray-200 divide-y divide-neutral-700">
            {users.length > 0 ? users.map((user, index) => (
              <tr key={user.id || index} className={`hover:bg-neutral-700/50 transition duration-150 ease-in-out  bg-neutral-850`}>
